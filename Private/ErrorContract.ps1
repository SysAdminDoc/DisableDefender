...
$script:ErrorCodeTable = @(
    ...
    [PSCustomObject]@{ Code = 'RESTORE_FAILED';       ExitCode = 6; Pattern = 'Restore verification';                 Repair = @('.\DisableDefender.ps1 -Mode Health -HealthTarget Restore', 'Follow the repair commands in the health output.') }
